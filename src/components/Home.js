      ...
      <Row>
        ...
        <Col xs={6} id="page-content">
          <Routes>
            ...
            <Route
              path="/InitializerFunction"
              element={<InitializerFunction />}
            />
            <Route path="/EventBubbling" element={<EventBubbling />} />
            <Route
              path="/PokemonApiComponent"
              element={<PokemonApiComponent />}
            />
            ...
            <Route
              path="/passStateInBootStrap"
              element={<PassStateToBootstrapComponent />}
            />
